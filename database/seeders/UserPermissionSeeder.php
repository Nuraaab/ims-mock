...
class UserPermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['key' => 'products.view', 'value' => 'View products'],
            ['key' => 'products.create', 'value' => 'Create products'],
            ['key' => 'products.update', 'value' => 'Update products'],
            ['key' => 'products.delete', 'value' => 'Delete products'],
            ...
            ['key' => 'items.view', 'value' => 'View items'],
            ['key' => 'items.create', 'value' => 'Create items'],
            ['key' => 'items.update', 'value' => 'Update items'],
            ['key' => 'items.delete', 'value' => 'Delete items'],
